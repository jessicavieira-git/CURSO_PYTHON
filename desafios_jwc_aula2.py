...
# nome_candidato = "Weridiana Maria"
# idade_candidato = 44
# print ("O nome da candidata é:", nome_candidato)
# print ("A idade da candidata é:", idade_candidato, "anos")
...
# print ("Nossa empresa possui", total_colaboradores_administrativos, "colaboradores administrativos e",
# total_colaboradores_desenvolvimento, "colaboradores desenvolvedores.")
# print ("O total geral de funcionários da nossa empresa é", total_geral_funcionarios, ".")
...
# print ("O status do seu processo seletivo é: ", status_atual_candidato)
...
# print (f"A sua linguagem favorita é {linguagem_favorita}, a minha também!")
...
# senha_temporaria_rede = "a senha é Python!"
...
# primeiro_nome = "Weridiana"
# sobrenome_candidato = "Santana"
...
# print (f"O total da remuneração inicial é {total_remuneracao_inicial}, resultado da soma do salário base de {valor_salario_base} com o auxilio ferramentas de {valor_auxilio_ferramentas}. Gaste com moderação!!!")
...
# nome_colaborador_input = input("Digite o seu nome: ")
# idade_colaborador_input = input("Digite a sua idade: ")
# pontuacao_teste_pratico = input("Qual a pontuação do teste prático? ")
# print (f"A colaboradora {nome_colaborador_input} possui {idade_colaborador_input} anos de idade, sua pontuação no teste prático foi igual a {pontuacao_teste_pratico}.")
